export default function Hero() {
  return (
    <section
      className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#060606] bg-cover bg-center bg-no-repeat px-6 text-center"
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center pt-12">
        ...
        <p className="mt-8 mx-auto max-w-3xl text-center text-base leading-relaxed text-zinc-400 sm:text-lg md:text-xl">
